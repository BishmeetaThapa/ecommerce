...
const categories = [
  ...
  { id: 7, name: 'Lipstick', image: 'https://akns-images.eonline.com/eol_images/Entire_Site/2023624/rs_1024x759-230724093424-1024-E_Insider_Shop-Best_Lipsticks-gj.jpg?fit=around%7C1024:759&output-quality=90&crop=1024:759;center,top' },
  { id: 8, name: 'Foundation', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRrEURwEirNbQJ48Mt6mm-7gDtS_fFkaL39iQ&s' },
  { id: 9, name: 'Bodycare', image: 'https://img.freepik.com/free-photo/top-view-bath-concept-accessories_23-2148419370.jpg?semt=ais_hybrid&w=740&q=80' },
  { id: 10, name: 'Accessories', image: 'https://img.freepik.com/free-photo/luxurious-shiny-golden-chain_23-2149635280.jpg?semt=ais_hybrid&w=740&q=80' },
...
const ProductCategories = () => {
  ...
  return (
    <section className={`w-full px-4 py-6 ${darkMode ? 'bg-gray-900' : 'bg-pink-50'}`}>
      <div className="flex justify-center">
        <div className="inline-flex gap-6 overflow-x-auto scrollbar-hide px-2">
          {categories.map((item) => (
            <div
              key={item.id}
              className="flex flex-col items-center min-w-[80px] cursor-pointer transition-transform duration-300 hover:scale-105"
            >
              {/* Circle with shadow */}
              <div className={`w-20 h-20 rounded-full flex items-center justify-center shadow-lg transition-colors duration-300 ${
